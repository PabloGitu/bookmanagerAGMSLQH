package com.tfg.bookmanageragmsqlh.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.tfg.bookmanageragmsqlh.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.tfg.bookmanageragmsqlh.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
